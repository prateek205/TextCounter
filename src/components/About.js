  ...
  return (
    <>
     <div className="container">
        ...
        <h4 className='mt-5'><strong>Text Analyzer</strong></h4>
        ...
        <h4 className='mt-5'><strong>Free to Use</strong></h4>
        ...
        <h4 className='mt-5'><strong>Browser Compatibility</strong></h4>
